...
document.addEventListener("click", (e) => {
  ...
  else if (act === "music-f-drop") { tbl.ui.musicFolderArm = val; paintSide(); }
  else if (act === "music-f-drop-cancel") { tbl.ui.musicFolderArm = ""; paintSide(); }
  else if (act === "music-f-drop-go") {
    if (tbl.ui.musicFolderArm !== val) return;
    tbl.ui.musicFolderArm = "";
    tblMusicFolderDrop(val).catch(tblFail);
  }
